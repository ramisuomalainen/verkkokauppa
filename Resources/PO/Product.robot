...
Choose Second Product
    Click Element  css=#app > div > div.main > div > div > div.search-page-content > div.search-results > ol:nth-child(1) > li:nth-child(2) > div > div.list-product__list-product-details > div.list-product-details__data > a > span
